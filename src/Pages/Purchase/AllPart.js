                ...
                <div className="card-body items-center text-center">
                    ...
                    <div className="card-actions">
                        <label
                            ...
                            className="btn btn-primary mt-2 text-black font-bold uppercase bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-pink-500 hover:to-yellow-500">Purchase</label>
                    </div>
                </div>
            </div>
        </>
