    ...
    return (
        <>
            <div>
                ...
                <div>
                    <div class="hero-content mb-16">


                        <div class="card flex-shrink-0 mr-16 w-full max-w-sm shadow-2xl bg-base-200">
                            <div class="card-body">
                                ...
                                <button class=" btn btn-primary text-xl text-white font-bold uppercase bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500">Contact Us</button>
                                </div>
                            </div>
                        </div>
